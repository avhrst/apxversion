...
,p_prn_page_header=>'Departments 5'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(8564246322351906)
,p_name=>'Departments'
...
,p_owner=>'ADMIN'
,p_internal_uid=>8564246322351906
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(8564613065351915)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(8565034358351924)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(8565445067351924)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(8595721489352006)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'85958'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'NAME:LOCATION'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(8568819593351935)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(8567980179351932)
,p_name=>'Edit Report - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(8564198179351905)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(8568455516351934)
,p_event_id=>wwv_flow_api.id(8567980179351932)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(8564198179351905)
);
end;
/
