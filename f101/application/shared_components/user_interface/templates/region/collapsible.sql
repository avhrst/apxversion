...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(8441486766351722)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8441758503351722)
,p_plug_template_id=>wwv_flow_api.id(8441486766351722)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8442087655351722)
,p_plug_template_id=>wwv_flow_api.id(8441486766351722)
,p_name=>'Sub Regions'
