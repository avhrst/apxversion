...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4442865026976770)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(4443184811976770)
,p_plug_template_id=>wwv_flow_api.id(4442865026976770)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(4443465987976770)
,p_plug_template_id=>wwv_flow_api.id(4442865026976770)
,p_name=>'Sub Regions'
