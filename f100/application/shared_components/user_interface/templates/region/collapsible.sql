...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5986332685085449090)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(776565598280524379)
,p_plug_template_id=>wwv_flow_api.id(5986332685085449090)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(776566173590524379)
,p_plug_template_id=>wwv_flow_api.id(5986332685085449090)
,p_name=>'Sub Regions'
