...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5986325570453449083)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(776549484581524366)
,p_plug_template_id=>wwv_flow_api.id(5986325570453449083)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(776549913585524367)
,p_plug_template_id=>wwv_flow_api.id(5986325570453449083)
,p_name=>'Slides'
