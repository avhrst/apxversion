...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5986349694881449102)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(776611089450524414)
,p_plug_template_id=>wwv_flow_api.id(5986349694881449102)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(776611566746524414)
,p_plug_template_id=>wwv_flow_api.id(5986349694881449102)
,p_name=>'Sub Regions'
