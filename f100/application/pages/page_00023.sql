...
,p_last_upd_yyyymmddhh24miss=>'20210525093812'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(2864624505056653962)
,p_name=>'&APP_NAME.'
,p_template=>wwv_flow_api.id(5986340181755449096)
...
,p_query_row_template=>wwv_flow_api.id(5986381634664449147)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(815386844211085749)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(815387282045085753)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(815387653747085753)
,p_query_column_id=>3
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4055772489787031831)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4055772880896031832)
,p_plug_name=>'Quick Start'
,p_parent_plug_id=>wwv_flow_api.id(4055772489787031831)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4055773078118031832)
...
'<p>',
'<ul>',
'<li>Cards with 3 different styles</li>',
'<li>Cards with Facted Search region</li>',
'<li>Cards with Images using BLOB column, URL, video in iFrame</li>',
'<li>Cards Actions</li>',
'<li>Oracle JET Data Visualizations in Cards</li>',
'<li>Template Directives in Cards</li>',
'</ul>',
'</p>'))
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4055773275029031832)
...
'<p>',
'This application highlights Cards regions in Oracle Application Express (APEX). Cards regions are a native region type. They provide developers with a powerful and flexible new way to display data in bite-sized blocks, ideal for use in faceted search'
||', or presenting at-a-glance information. This application demonstrates how you can use Cards regions to enhance your applications and present data in new ways.',
'</p>',
''))
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
