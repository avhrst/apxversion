...
,p_last_upd_yyyymmddhh24miss=>'20211017002242'
);
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(54460375582223059)
,p_plug_name=>'Language Selector'
,p_parent_plug_id=>wwv_flow_api.id(54455785618223046)
,p_region_template_options=>'#DEFAULT#'
...
,p_button_plug_id=>wwv_flow_api.id(54455785618223046)
,p_button_name=>'LOGIN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28202202416825937)
,p_name=>'P2_REMEMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(54455785618223046)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(28203743749825970)
...
'    p_consent  => :P2_REMEMBER = ''Y'' );'))
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(28203473510825969)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(28204592901825970)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(28204150094825970)
,p_process_sequence=>10
