...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1135659910785986863)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(1135660038845986864)
,p_region_id=>wwv_flow_api.id(1135659910785986863)
,p_chart_type=>'bar'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(1359335078489991215)
,p_chart_id=>wwv_flow_api.id(1135660038845986864)
,p_seq=>10
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1359335130903991216)
,p_chart_id=>wwv_flow_api.id(1135660038845986864)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1359335223821991217)
,p_chart_id=>wwv_flow_api.id(1135660038845986864)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1359335394108991218)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(1359335414494991219)
,p_region_id=>wwv_flow_api.id(1359335394108991218)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
,p_orientation=>'vertical'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(1359335548184991220)
,p_chart_id=>wwv_flow_api.id(1359335414494991219)
,p_seq=>10
,p_name=>'Asset Commitment'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1359335723258991222)
,p_chart_id=>wwv_flow_api.id(1359335414494991219)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_type=>'decimal'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1359335683403991221)
,p_chart_id=>wwv_flow_api.id(1359335414494991219)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15809903545294180784)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15809961683395325184)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15809962517143326368)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15810134027969507861)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15882543417567355136)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15809978722209378455)
,p_button_sequence=>1000
,p_button_plug_id=>wwv_flow_api.id(15809903545294180784)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15809962801333326369)
,p_name=>'P86_CATEGORY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(15809962517143326368)
,p_item_default=>'0'
,p_prompt=>'Category'
,p_source=>'0'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15911956348906394794)
,p_name=>'P86_GEO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(15809962517143326368)
,p_prompt=>'Geography'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15911959136775452270)
,p_name=>'cat'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15911960443260454969)
,p_event_id=>wwv_flow_api.id(15911959136775452270)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(15882543417567355136)
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15911962799794465824)
,p_event_id=>wwv_flow_api.id(15911959136775452270)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(15809961683395325184)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15911960739617459331)
,p_name=>'geo'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15911962060430462107)
,p_event_id=>wwv_flow_api.id(15911960739617459331)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15911962456837463712)
,p_event_id=>wwv_flow_api.id(15911960739617459331)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
