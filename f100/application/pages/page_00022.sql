...
,p_last_upd_yyyymmddhh24miss=>'20210504173540'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(800238849556022633)
...
,p_list_id=>wwv_flow_api.id(813504161656947325)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(5986396622451449162)
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(813503408246941724)
