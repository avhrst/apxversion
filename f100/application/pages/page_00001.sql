...
,p_last_upd_yyyymmddhh24miss=>'20211020205638'
);
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(90555901911599819)
,p_plug_name=>'App1'
,p_icon_css_classes=>'app-icon'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(26160372005397043)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(90560491875599832)
,p_plug_name=>'Language Selector'
,p_parent_plug_id=>wwv_flow_api.id(90555901911599819)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(26130673274397033)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(90655891054650258)
,p_plug_name=>'App1'
,p_icon_css_classes=>'app-icon'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(26160372005397043)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(90660481018650271)
,p_plug_name=>'Language Selector'
,p_parent_plug_id=>wwv_flow_api.id(90655891054650258)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(26130673274397033)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(90760567984655964)
,p_plug_name=>'Language Selector'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(36100466896376816)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(90555901911599819)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(26226728984397080)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(36200400517427245)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(90655891054650258)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(26226728984397080)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36100884933376822)
,p_name=>'P1_USERNAME_2'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(90555901911599819)
,p_prompt=>'Username'
,p_placeholder=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36101259738376825)
,p_name=>'P1_PASSWORD_2'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(90555901911599819)
,p_prompt=>'Password'
,p_placeholder=>'Password'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36101634170376826)
,p_name=>'P1_REMEMBER_2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(90555901911599819)
,p_prompt=>'Remember username'
,p_display_as=>'NATIVE_CHECKBOX'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36200826623427251)
,p_name=>'P1_USERNAME_3'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(90655891054650258)
,p_prompt=>'Username'
,p_placeholder=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36201188975427255)
,p_name=>'P1_PASSWORD_3'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(90655891054650258)
,p_prompt=>'Password'
,p_placeholder=>'Password'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36201527635427255)
,p_name=>'P1_REMEMBER_3'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(90655891054650258)
,p_prompt=>'Remember username'
,p_display_as=>'NATIVE_CHECKBOX'
