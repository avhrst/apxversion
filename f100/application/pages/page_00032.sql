...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1143957905962070228)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(1143958089990070229)
,p_region_id=>wwv_flow_api.id(1143957905962070228)
,p_chart_type=>'bar'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(1143958108008070230)
,p_chart_id=>wwv_flow_api.id(1143958089990070229)
,p_seq=>10
,p_name=>'Category'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1143958308091070232)
,p_chart_id=>wwv_flow_api.id(1143958089990070229)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1143958284838070231)
,p_chart_id=>wwv_flow_api.id(1143958089990070229)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15808983226126020790)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15908080045359547023)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15911964453799489510)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(15808983226126020790)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15908080321302547024)
,p_name=>'P32_CATEGORY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(15908080045359547023)
,p_item_default=>'0'
,p_prompt=>'Category'
,p_source=>'0'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15911965164453495673)
,p_name=>'P32_GEO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(15908080045359547023)
,p_prompt=>'Geography'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15908085331807568084)
,p_name=>'set cat'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1143958452110070233)
,p_event_id=>wwv_flow_api.id(15908085331807568084)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(1143957905962070228)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15911965641591502247)
,p_name=>'geo'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1143958566827070234)
,p_event_id=>wwv_flow_api.id(15911965641591502247)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
